...
class RPSEnvNoBot(gym.Env):
    def __init__(
        ...
        # create rwc env
        substrate_config = substrate.get_config("running_with_scissors_in_the_matrix")
        self._env = substrate.build(config_dict.ConfigDict(substrate_config))
        self._env._rng = np.random.RandomState(seed=seed)
